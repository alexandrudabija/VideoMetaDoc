...
export class CartService {
  ...
  clearCart(): void {
    ...
    this.snackBar.open(this.translate.instant('Cart is cleared.'), 'ok', { duration: 3000 });
  ...
  removeOneItem(item: CartItem): void {
    ...
    this.snackBar.open(this.translate.instant('1 item removed from cart .'), 'ok', { duration: 3000 });
  }
